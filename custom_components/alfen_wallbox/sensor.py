...
class AlfenSensor(AlfenEntity, SensorEntity):
    ...
    def state(self) -> StateType:
        ...
        if self.entity_description.api_param is None:
            ...
            if self.entity_description.key in ["custom_tag_socket_1_charged_time", "custom_tag_socket_1_charged_time"]:
                if self._device.latest_tag is None:
                    return "Unknown"
            ...
            if self.entity_description.key in ["custom_tag_socket_2_charged_time", "custom_tag_socket_2_charged_time"]:
                if self._device.latest_tag is None:
                    return "Unknown"
